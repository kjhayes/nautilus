...
class Kconfig(object):
    ...
    def _init(self, filename, warn, warn_to_stderr, encoding):
        ...
        self.config_prefix = os.getenv("NAUT_CONFIG_", "NAUT_CONFIG_")
    ...
    def write_config(self, filename=None, header=None, save_old=True,
        ...
        self.write_autoconf('include/autoconf.h')

        # KJH - We don't need this for Nautilus
...
def menuconfig(kconf):
    ...
    _kconf.config_prefix = 'NAUT_CONFIG_'
